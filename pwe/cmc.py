...
def binance(symbol='BTCUSDT',start_date=None,end_date=None, interval='1h', your_tz="Asia/Dubai"):
    ...
    file_path = os.path.abspath(f'csv_files/Binance/{tkr}_{interval}_{csv_start}_{csv_end}.csv')
    if os.path.exists(file_path) == True:
        ...
        df = pd.read_csv(file_path,low_memory=False, index_col=['DateTime'], parse_dates=['DateTime'],infer_datetime_format=True)
